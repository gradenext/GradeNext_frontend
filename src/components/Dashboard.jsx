...
import { BookOpen, Calculator, Languages, Trophy, Clock, ListChecks, Rocket, Sparkles, Gem, Puzzle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 p-6 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-xl text-gray-700" style={{ fontFamily: "'Comic Neue', cursive" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div 
              ...
              animate={{ opacity: 1 }}
            >
              <h2 className="text-2xl font-bold" style={{ color: colors.primary, fontFamily: "'Bubblegum Sans', cursive" }}>
                🎯 Choose Your Subject
              </h2>
                ...
                {subjects.map((subject) => (
                  <motion.div
                    ...
                    className={`p-6 rounded-2xl cursor-pointer transition-all ${selectedSubject === subject.id ? 
                      'ring-4 shadow-xl' : 'shadow-lg hover:shadow-xl'}`}
                    style={{ 
                      backgroundColor: selectedSubject === subject.id ? 
                        `${subject.color}20` : 'white',
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold mb-1" style={{ color: subject.color }}>
                          {subject.label}
                        </h3>
            ...
            >
              <h2 className="text-2xl font-bold" style={{ color: colors.secondary, fontFamily: "'Bubblegum Sans', cursive" }}>
                🎮 Learning Activities
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {actions.map((action) => (
                  <motion.div
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`p-6 rounded-2xl cursor-pointer transition-all ${selectedMode === action.id ? 
                      'ring-4 shadow-xl' : 'shadow-lg hover:shadow-xl'}`}
                    style={{ 
                      backgroundColor: selectedMode === action.id ? 
                        `${action.color}20` : 'white',
                      borderColor: action.color
                    }}
                    onClick={() => setSelectedMode(action.id)}
                  >
                    <div className="flex flex-col items-center gap-3">
                      <div className="p-3 rounded-xl" style={{ backgroundColor: `${action.color}20` }}>
                        {action.icon}
                      </div>
                      <h3 className="text-xl font-bold text-center" style={{ color: action.color }}>
                        {action.label}
                      </h3>
          ...
          <div className="space-y-8">
            ...
            >
              <h2 className="text-2xl font-bold mb-6" style={{ color: colors.accent, fontFamily: "'Bubblegum Sans', cursive" }}>
                📊 Your Progress
              </h2>
                ...
                {stats.map((stat, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600" style={{ fontFamily: "'Comic Neue', cursive" }}>
                        {stat.label}
                      </span>
                    ...
                    <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                      <motion.div
                        ...
                        style={{ backgroundColor: [colors.primary, colors.secondary, colors.accent, colors.success][index % 4] }}
                      />
                    </div>
                  </div>
                ))}
            ...
            >
              <button
                onClick={handleStart}
                disabled={!selectedSubject || !selectedMode || isLoading}
