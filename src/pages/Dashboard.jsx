...
const Dashboard = () => {
  ...
  const courses = useStore((state) => state.user.courses);
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <h1
            className="text-4xl md:text-5xl font-bold pb-2 text-transparent bg-clip-text"
            style={{
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {subjects
                  ?.filter((item) =>
                    courses.find((course) => course === item.id)
                  )
                  .map((subject) => (
                    <motion.div
                      key={subject.id}
